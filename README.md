...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bhmeexw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bhmeexw.containers.anotherwebservice.com/
...
```
git clone git@github.com:swan-world-wide-you/container-bhmeexw.git
cd container-bhmeexw
```
...
```
docker attach container-bhmeexw
```
